...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.mango.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.mango.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.mango.model.dto.Blog blog, String type) {
		//验证普通字段
