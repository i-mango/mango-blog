...
import top.mango.annotation.AccessLimit;
import top.mango.constant.JwtConstants;
import top.mango.entity.User;
import top.mango.model.dto.Comment;
import top.mango.model.vo.PageComment;
import top.mango.model.vo.PageResult;
import top.mango.model.vo.Result;
import top.mango.service.CommentService;
import top.mango.service.impl.UserServiceImpl;
import top.mango.util.JwtUtils;
import top.mango.util.StringUtils;
import top.mango.util.comment.CommentUtils;
import top.mango.enums.CommentOpenStateEnum;
...
public class CommentController {
	...
	public Result postComment(@RequestBody Comment comment,
		...
		//父评论
		top.mango.entity.Comment parentComment = null;
